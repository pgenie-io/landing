...
let page-doc =
      \(page : Page) ->
        let install-button-elements =
              \(z : InstallButton) ->
                ''
                <a class="btn btn--large" href="https://github.com/pgenie-io/cli/releases/download/${page.cli-version}/pgenie-cli-${page.cli-version}-${z.url-suffix}.zip" target="_blank"
        ...
        in  ''
            ...
            <body>
              ...
              <div id="titles" class="section section--titles section--center" style="background-color:black;padding:180px 0 120px 0;--pdx-min-height:0px;--wr-max:1030px">
                <div class="wr">
                  <h1 class="color-1 weight-title-h font-title section__title center">${page.description}</h1>
